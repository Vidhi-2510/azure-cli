...
class BackupTests(ScenarioTest, unittest.TestCase):
    ...
    def test_backup_identity(self, resource_group, vault_name):
        ...
        userMSI1_json = self.cmd('backup vault update --identity-type userassigned --identity-id {identity1_id} {identity2_id} -g {rg} -v {vault}', checks=[
            self.check("identity.type", "UserAssigned"),
            self.check("properties.provisioningState", "Succeeded")
        ]).get_output_in_json()


        userMSI = list(userMSI1_json['identity']['userAssignedIdentities'].keys())

        self.assertIn(self.kwargs['identity1_id'], userMSI)
        self.assertIn(self.kwargs['identity2_id'], userMSI)

        userMSI1_json = self.cmd('backup vault update --identity-type systemassigned -g {rg} -v {vault}', checks=[
        ...
        userMSI1_json = self.cmd('backup vault update --remove-system-assigned -g {rg} -v {vault}', checks=[
            self.check("identity.type", "UserAssigned"),
            self.check("properties.provisioningState", "Succeeded")
        ]).get_output_in_json()
        ...
        userMSI1_json = self.cmd('backup vault update --identity-type userassigned --identity-id {identity3_id} -g {rg} -v {vault}', checks=[
            self.check("identity.type", "UserAssigned"),
            self.check("properties.provisioningState", "Succeeded")
        ]).get_output_in_json()
        ...
        userMSI1_json = self.cmd('backup vault update --remove-user-assigned --identity-id {identity1_id} -g {rg} -v {vault}', checks=[
            self.check("identity.type", "UserAssigned"),
            self.check("properties.provisioningState", "Succeeded")
        ]).get_output_in_json()
        ...
        userMSI1_json = self.cmd('backup vault update --identity-type userassigned --identity-id {identity1_id} -g {rg} -v {vault}', checks=[
            self.check("identity.type", "SystemAssigned, UserAssigned"),
            self.check("properties.provisioningState", "Succeeded")
        ]).get_output_in_json()
        ...
        userMSI1_json = self.cmd('backup vault update --identity-type userassigned --identity-id {identity2_id} {identity3_id} -g {rg} -v {vault}', checks=[
            self.check("identity.type", "SystemAssigned, UserAssigned"),
            self.check("properties.provisioningState", "Succeeded")
        ]).get_output_in_json()
        ...
        userMSI1_json = self.cmd('backup vault update --remove-user-assigned --identity-id {identity2_id} {identity3_id} -g {rg} -v {vault}', checks=[
            self.check("identity.type", "SystemAssigned, UserAssigned"),
            self.check("properties.provisioningState", "Succeeded")
        ]).get_output_in_json()
    ...
    def test_backup_encryption(self, resource_group, resource_group_location, vault1, vault2):
        ...
        userMSI1_v1_json = self.cmd('backup vault update --identity-type userassigned --identity-id {identity1_id} -g {rg} -v {vault1}', checks=[
            self.check("identity.type", "UserAssigned"),
            self.check("properties.provisioningState", "Succeeded")
        ]).get_output_in_json()


        userMSI_v1 = list(userMSI1_v1_json['identity']['userAssignedIdentities'].keys())

        self.assertIn(self.kwargs['identity1_id'], userMSI_v1)

        userMSI2_v1_json = self.cmd('backup vault update --identity-type userassigned --identity-id {identity2_id} -g {rg} -v {vault1}', checks=[
            self.check("identity.type", "UserAssigned"),
            self.check("properties.provisioningState", "Succeeded")
        ]).get_output_in_json()


        userMSI_v1 = list(userMSI2_v1_json['identity']['userAssignedIdentities'].keys())
