...
helps['backup encryption'] = """
type: group
short-summary: Encryption details of Recovery service Vault.
"""
helps['backup encryption update'] = """
type: command
short-summary: Updates encryption properties of Recovery service Vault.
examples:
  - name: Updates encryption properties of Recovery service Vault.
    text: az backup encryption update --encryption-key-id MyKeyUri --resource-group MyResourceGroup --vault-name MyVault 
"""
helps['backup encryption show'] = """
type: command
short-summary: Show details of encryption properties of Recovery service Vault.
examples:
  - name: Show details of encryption properties of Recovery service Vault.
    text: az backup encryption show --resource-group MyResourceGroup --vault-name MyVault 
"""
...
type: command
short-summary: Updates an existing Recovery service vault.
examples:
  - name: Updates an existing Recovery service vault. (autogenerated)
